...
pub struct Transaction {
    #[serde(rename = "application-transaction", skip_serializing_if = "Option::is_none")]
    pub application_transaction: Option<Box<crate::models::TransactionApplication>>,
    #[serde(rename = "asset-config-transaction", skip_serializing_if = "Option::is_none")]
    pub asset_config_transaction: Option<Box<crate::models::TransactionAssetConfig>>,
    #[serde(rename = "asset-freeze-transaction", skip_serializing_if = "Option::is_none")]
    pub asset_freeze_transaction: Option<Box<crate::models::TransactionAssetFreeze>>,
    #[serde(rename = "asset-transfer-transaction", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "created-application-index", skip_serializing_if = "Option::is_none")]
    ...
    pub signature: Box<crate::models::TransactionSignature>,
...
impl Transaction {
    ...
    pub fn new(fee: i32, first_valid: i32, id: String, last_valid: i32, sender: String, signature: crate::models::TransactionSignature, tx_type: TxType) -> Transaction {
        Transaction {
