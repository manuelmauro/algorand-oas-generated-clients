...
pub struct Block {
    ...
    #[serde(rename = "participation-updates", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "state-proof-tracking", skip_serializing_if = "Option::is_none")]
...
impl Block {
    ...
    pub fn new(genesis_hash: String, genesis_id: String, previous_block_hash: String, round: i32, seed: String, timestamp: i32, transactions_root: String, transactions_root_sha256: String) -> Block {
        Block {
            genesis_hash,
            genesis_id,
