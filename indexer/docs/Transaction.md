...
**auth_addr** | Option<**String**> | \\[sgnr\\] this is included with signed transactions when the signing address does not equal the sender. The backend can use this to ensure that auth addr is equal to the accounts auth addr. | [optional]
...
**id** | Option<**String**> | Transaction ID | [optional]
**inner_txns** | Option<[**Vec<crate::models::Transaction>**](Transaction.md)> | Inner transactions produced by application execution. | [optional]
