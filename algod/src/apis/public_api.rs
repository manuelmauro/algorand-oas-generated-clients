...
pub async fn account_application_information(configuration: &configuration::Configuration, address: &str, application_id: i32, format: Option<&str>) -> Result<crate::models::AccountApplicationInformation200Response, Error<AccountApplicationInformationError>> {
...
pub async fn account_asset_information(configuration: &configuration::Configuration, address: &str, asset_id: i32, format: Option<&str>) -> Result<crate::models::AccountAssetInformation200Response, Error<AccountAssetInformationError>> {
    let local_var_configuration = configuration;
...
pub async fn get_application_box_by_name(configuration: &configuration::Configuration, application_id: i32, name: &str) -> Result<crate::models::Box, Error<GetApplicationBoxByNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetApplicationBoxByNameError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_application_boxes(configuration: &configuration::Configuration, application_id: i32, max: Option<i32>) -> Result<crate::models::GetApplicationBoxes200Response, Error<GetApplicationBoxesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetApplicationBoxesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_block(configuration: &configuration::Configuration, round: i32, format: Option<&str>) -> Result<crate::models::GetBlock200Response, Error<GetBlockError>> {
    let local_var_configuration = configuration;
...
pub async fn get_block_hash(configuration: &configuration::Configuration, round: i32) -> Result<crate::models::GetBlockHash200Response, Error<GetBlockHashError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBlockHashError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_light_block_header_proof(configuration: &configuration::Configuration, round: i32) -> Result<crate::models::LightBlockHeaderProof, Error<GetLightBlockHeaderProofError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetLightBlockHeaderProofError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_state_proof(configuration: &configuration::Configuration, round: i32) -> Result<crate::models::StateProof, Error<GetStateProofError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetStateProofError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_supply(configuration: &configuration::Configuration, ) -> Result<crate::models::GetSupply200Response, Error<GetSupplyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_sync_round(configuration: &configuration::Configuration, ) -> Result<crate::models::GetSyncRound200Response, Error<GetSyncRoundError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSyncRoundError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_transaction_proof(configuration: &configuration::Configuration, round: i32, txid: &str, hashtype: Option<&str>, format: Option<&str>) -> Result<crate::models::GetTransactionProof200Response, Error<GetTransactionProofError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTransactionProofError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn set_sync_round(configuration: &configuration::Configuration, round: i32) -> Result<(), Error<SetSyncRoundError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetSyncRoundError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn simulate_transaction(configuration: &configuration::Configuration, request: crate::models::SimulateRequest, format: Option<&str>) -> Result<crate::models::SimulateTransaction200Response, Error<SimulateTransactionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SimulateTransactionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn teal_compile(configuration: &configuration::Configuration, source: std::path::PathBuf, sourcemap: Option<bool>) -> Result<crate::models::TealCompile200Response, Error<TealCompileError>> {
    let local_var_configuration = configuration;
...
pub async fn teal_disassemble(configuration: &configuration::Configuration, source: String) -> Result<crate::models::TealDisassemble200Response, Error<TealDisassembleError>> {
    let local_var_configuration = configuration;
...
pub async fn teal_dryrun(configuration: &configuration::Configuration, request: Option<crate::models::DryrunRequest>) -> Result<crate::models::TealDryrun200Response, Error<TealDryrunError>> {
    let local_var_configuration = configuration;
...
pub async fn transaction_params(configuration: &configuration::Configuration, ) -> Result<crate::models::TransactionParams200Response, Error<TransactionParamsError>> {
    let local_var_configuration = configuration;
...
pub async fn unset_sync_round(configuration: &configuration::Configuration, ) -> Result<(), Error<UnsetSyncRoundError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnsetSyncRoundError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn wait_for_block(configuration: &configuration::Configuration, round: i32) -> Result<crate::models::GetStatus200Response, Error<WaitForBlockError>> {
    let local_var_configuration = configuration;
