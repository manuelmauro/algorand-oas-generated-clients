...
/// InlineResponse2007 : NodeStatus contains the information about a node status
...
impl InlineResponse2007 {
    ...
    pub fn new(catchup_time: i32, last_round: i32, last_version: String, next_version: String, next_version_round: i32, next_version_supported: bool, stopped_at_unsupported_round: bool, time_since_last_round: i32) -> InlineResponse2007 {
        InlineResponse2007 {
            catchpoint: None,
