...
/// InlineResponse20011 : Details about a pending transaction. If the transaction was recently confirmed, includes confirmation details like the round and reward details.
...
impl InlineResponse20011 {
    ...
    pub fn new(pool_error: String, txn: serde_json::Value) -> InlineResponse20011 {
        InlineResponse20011 {
