...
/// InlineResponse20010 : TransactionParams contains the parameters that help a client construct a new transaction.
...
impl InlineResponse20010 {
    ...
    pub fn new(consensus_version: String, fee: i32, genesis_hash: String, genesis_id: String, last_round: i32, min_fee: i32) -> InlineResponse20010 {
        InlineResponse20010 {
            consensus_version,
            fee,
            genesis_hash,
